...
public class ApplicationDbContextInitialiser
{
    ...
    public async Task TrySeedAsync()
    {
        ...
        if (!_context.LicenseCategories.Any())
        {
            await _context.LicenseCategories.AddRangeAsync(new List<LicenseCategory>()
            {
                new LicenseCategory { Name = "A", CreatedBy = "667df7db-46a3-419e-9aad-98561fcb891e" },
                new LicenseCategory { Name = "B", CreatedBy = "667df7db-46a3-419e-9aad-98561fcb891e" },
                new LicenseCategory { Name = "C", CreatedBy = "667df7db-46a3-419e-9aad-98561fcb891e" },
                new LicenseCategory { Name = "D", CreatedBy = "667df7db-46a3-419e-9aad-98561fcb891e" },
            });
        ...
        {
            await _context.AddRangeAsync(new List<VehicleType>
            {
                new VehicleType { Name = "Sedan" },
                new VehicleType { Name = "Station" },
                new VehicleType { Name = "Jeep" },
                new VehicleType { Name = "Saloon" },
                new VehicleType { Name = "Saloon Box" },
                new VehicleType { Name = "Jeep Box" },
                new VehicleType { Name = "Pickup" },
                new VehicleType { Name = "Trilla" },
                new VehicleType { Name = "Ras" },
                new VehicleType { Name = "Refrigerator" },
                new VehicleType { Name = "Motorcycle" },
                new VehicleType { Name = "Van" },
                new VehicleType { Name = "Coupe" },
                new VehicleType { Name = "Sport" },
            });
            await _context.SaveChangesAsync();
        }
        // Default users
